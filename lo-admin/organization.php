...
$_SESSION['cur_page'] = 'org';
$pageName             = "Manage Organization" . SITE_NAME;
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="<?php echo _ADMIN_HOME.'/user/add.php?user=organisation';?>" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i>
                    Add Organization</a>
            </div>
        </div>
        ...
        <div class="search-filter">
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="">
                <input type="hidden" value="O" class="u_type">
